...
import { CombinedExchangeRate } from "@/store/exchange/exchangeTypes.ts";
...
<template>
  <div class="overflow-x-auto shadow-lg rounded-lg border border-gray-200">
    ...
    <table class="min-w-full table-auto">
      ...
      <tr v-for="(exchange, index) in excgangeList"
          :key="index"
          class="border-b">
        ...
        <td class="px-6 py-4 text-yellow-500 font-semibold">{{exchange.bestBuy}}</td> <!-- Средний Buy курс -->
        <td class="px-6 py-4 text-yellow-500 font-semibold">{{exchange.bestSell}}</td> <!-- Средний Sell курс -->
    ...
    <table class="min-w-full table-auto">
        ...
        <tbody class="text-sm text-gray-900">
        <!-- Строки данных для каждого банка и его курсов -->
